    ...
    <React.Fragment>
      ...
      >
        ...
        <ul className='menu-list p-c-10 line-height'>
          ...
          <li>
            <a className='is-selected'>Visualize COVID-19 on planetary scale</a>
          </li>
          {/* <li><a>About</a></li> */}
        </ul>
            ...
            <div className='content'>
              ...
              {activeTabs[1] && (
                <div>
                  ...
                  people, and people with other medical conditions (such as
                  asthma, diabetes, or heart disease), may be more vulnerable to
